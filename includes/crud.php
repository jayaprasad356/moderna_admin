...
define('DOMAIN_URL', 'https://moderna.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_moderna";  // Change as required
    private $db_pass = "Moderna@0111";  // Change as required
    private $db_name = "u743445510_moderna";    // Change as required
